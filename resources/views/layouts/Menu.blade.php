      ...
      <nav class="navbar navbar-expand-md bg-dark sticky-top navbar-dark">
        <a class="navbar-brand p-2" href="#">Menu Principal</a>
          <ul class="navbar-nav col-4">
            ...
            <li class="nav-item active ">
              <div class="dropdown">
                <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">Connexion</button>
                    <ul class="dropdown-menu">
                      <li><a class="dropdown-item" href="{{ route('login') }}" class="dropdown">Log in</a></li>
                      <li><a class="dropdown-item" href="{{ route('register') }}" class="dropdown">Register</a></li>
                    </ul>
              </div>
            </li>
          </ul>
